...
const HeroSection = () => {
  ...
  return <section className="text-center sm:py-16 px-4 py-[4px]">
      ...
      <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight mb-4 max-w-4xl mx-auto leading-tight">
      ...
      <p className="text-base text-muted-foreground max-w-3xl mx-auto mb-6">With one tap or scan, Love Key™ connects you to personal safety and wellbeing support when it matters most. It's a quiet promise that you, or someone you love, is never truly alone in a moment of need.</p>
