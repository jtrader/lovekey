  ...
  <Html lang="en" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        {shippingAddress && (
          <Section style={orderBox}>
            <Text style={label}>Delivery to</Text>
        ...
        <Hr style={divider} />
        <Text style={text}>
          We'll send you a delivery update once your order is on its way. If you have any questions, reply to this email or reach out at support@lovekey.com.au.
        </Text>
